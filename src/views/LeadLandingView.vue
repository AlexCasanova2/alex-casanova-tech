...
/* A wide editorial column keeps long ES/CA headlines readable. */
.lead-hero {
  min-height: auto;
...
.hero-copy > p { max-width: 620px; font-size: 1.0625rem; line-height: 1.7; }
.actions { margin-top: 28px; flex-wrap: wrap; }
.proof, .price-stamp { align-self: center; padding-top: 24px; border-color: var(--border-color); }
.proof strong, .price-stamp strong { font-size: 2.75rem; }
.proof p { line-height: 1.6; margin-top: 16px; }
.lead-section { padding-block: 48px 72px; }
.lead-section > h2, .process-grid h2, .pricing-layout h2 {
  max-width: 640px;
  font-size: clamp(1.6rem, 2.5vw, 2.2rem);
  line-height: 1.2;
  text-wrap: balance;
}
.lead-section > h2 { margin-bottom: 32px; }
.service-grid h3 { margin-top: 32px; font-size: 1.25rem; }
.process-band { padding-block: 64px; }
.process-grid { gap: 48px; }
.process-grid li { font-size: 1.0625rem; line-height: 1.6; }
.pricing-layout { padding-block: 48px 64px; gap: 48px; }
.included { transform: none; padding: 30px; border-radius: 12px; }
.price-factors h3 { font-size: 1.25rem; line-height: 1.3; margin-bottom: 8px; }
...
.final-cta p { font-size: 1rem; line-height: 1.7; }
@media (max-width: 800px) {
  .lead-hero { grid-template-columns: minmax(0, 1fr); gap: 28px; }
  .hero-copy h1 { max-width: 680px; }
  .proof, .price-stamp { max-width: none; width: 100%; padding-top: 20px; }
  .proof { display: grid; grid-template-columns: auto 1fr; gap: 6px 20px; align-items: center; }
  .proof strong { grid-row: span 2; }
  .proof p { margin: 0; }
  .pricing-layout, .process-grid { gap: 32px; }
  .actions { flex-direction: row; align-items: center; gap: 16px 24px; }
  .lead-section { padding-block: 32px 48px; }
  .process-band, .final-cta { padding-block: 48px; }
}
